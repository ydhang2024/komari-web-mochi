      ...
      >
        ...
        <Flex direction="column" gap="2" align={{ initial: 'center', md: 'start' }}>
          <Text size="2" color="gray">
            Powered by <a href='https://github.com/komari-monitor/komari' className='font-bold' target='_blank'>Komari Monitor</a>.
            Theme <a href='https://github.com/svnmoe/komari-web-mochi'  className='font-bold' target='_blank'>Mochi</a>.
          </Text>
          {buildTime && (
